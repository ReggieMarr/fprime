...
#include "FPrimeTMTransferFrame.hpp"
...
Fw::SerializeStatus FprimeTM<FrameSize, SecondaryHeaderSize, TrailerSize>::serialize(Fw::SerializeBufferBase& buffer, TransferData_t transferData, const U8* const data, const U32 size) {
