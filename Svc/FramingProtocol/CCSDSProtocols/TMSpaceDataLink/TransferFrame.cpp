...
Fw::SerializeStatus DataField::serialize(Fw::SerializeBufferBase& buffer) const {
    return m_data.serialize(buffer);
}

Fw::SerializeStatus DataField::deserialize(Fw::SerializeBufferBase& buffer) {
    return m_data.deserialize(buffer);
}

Fw::SerializeStatus DataField::serialize(const U8* buff, FwSizeType length) {
    Fw::SerializeBufferBase& serBuff = m_data.getSerializeRepr();
    return serBuff.serialize(buff, length, false);
}

Fw::SerializeStatus DataField::deserialize(U8* buff, NATIVE_UINT_TYPE length) {
    Fw::SerializeBufferBase& serBuff = m_data.getSerializeRepr();
