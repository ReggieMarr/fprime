...
Fw::SerializeStatus TransferFrame::serialize(Fw::SerializeBufferBase& buffer,
                                             ...
                                             const U8* const data, const U32 size) {
        Fw::SerializeStatus status;
        ...
        Fw::Logger::log(
                ...
                m_primaryHeader.getControlInfo().transferFrameVersion,
                m_primaryHeader.getControlInfo().spacecraftId,
                m_primaryHeader.getControlInfo().virtualChannelId,
                m_primaryHeader.getControlInfo().operationalControlFlag,
                m_primaryHeader.getControlInfo().masterChannelFrameCount,
                m_primaryHeader.getControlInfo().virtualChannelFrameCount,
                serializedSize,
