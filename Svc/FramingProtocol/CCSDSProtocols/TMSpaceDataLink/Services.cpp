...
TMService<SDU_t, SAP_t, ServiceParams_t, ServiceTransferPrimitive_t, SERVICE_TRANSFER_TYPE>::
...
template<typename SDU_t,
         ...
         typename ServiceTransferPrimitive_t,
         SERVICE_TRANSFER_TYPE_t SERVICE_TRANSFER_TYPE>
bool TMService<SDU_t, SAP_t, ServiceParams_t, ServiceTransferPrimitive_t, SERVICE_TRANSFER_TYPE>::
    transfer(Fw::ComBuffer const &transferBuffer)
{
